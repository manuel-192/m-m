...
Resembles tools like [reflector](https://www.archlinux.org/packages/community/any/reflector)
and [reflector-antergos](https://github.com/manuel-192/antergos-reflector).
## Usage
remirror --help
## Changes

0.1.56: 2019-July-06
- Changed default operating system of option --os from 'both' to 'Arch' due to Anteros discontinuation.

0.1.55: 2019-May-17
- Added more info about the configuration file /etc/remirror.conf to the output provided by the --help option.

0.1.54: 2019-May-15
- Added info about the configuration file /etc/remirror.conf to the output provided by the --help option.
- Please note that variables REMIRROR_PREOPTIONS and REMIRROR_POSTOPTIONS in file /etc/remirror.conf are now string arrays instead of plain strings. This was changed in remirror 0.1.53 already.
